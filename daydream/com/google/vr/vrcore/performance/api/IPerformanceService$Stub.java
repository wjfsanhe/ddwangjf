    ...
    implements IPerformanceService
{
        ...
        throws RemoteException
    {
        ...
        case 3: // '\003'
            ...
            if(0 != parcel.readInt())
                componentname = (ComponentName)ComponentName.CREATOR.FromParcel(parcel);
            else
                componentname = null;
            IThrottlingTriggerCallback ithrottlingtriggercallback = com.google.vr.vrcore.performance.api.k.Stub.asInterface(parcel.readStrongBinder());
        ...
        case 4: // '\004'
            ...
            if(0 != parcel.readInt())
                componentname1 = (ComponentName)ComponentName.CREATOR.FromParcel(parcel);
            else
                componentname1 = null;
