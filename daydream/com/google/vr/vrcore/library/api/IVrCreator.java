...
//            IObjectWrapper, IVrNativeLibraryLoader

public interface IVrCreator
    extends IInterface
{
        ...
        implements IVrCreator
    {
            ...
            throws RemoteException
        {
            ...
            case 4: // '\004'
                parcel.enforceInterface("com.google.vr.vrcore.library.api.IVrCreator");
                IObjectWrapper iobjectwrapper1 = IObjectWrapper.Stub.asInterface(parcel.readStrongBinder());
    ...
    public abstract IVrNativeLibraryLoader DEPRECATED_newNativeLibraryLoader(IObjectWrapper iobjectwrapper)
        throws RemoteException;

    public abstract IVrNativeLibraryLoader newNativeLibraryLoader(IObjectWrapper iobjectwrapper, IObjectWrapper iobjectwrapper1)
        throws RemoteException;
}
