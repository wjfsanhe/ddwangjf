...
//            IDaydreamListener, HeadTrackingState, ITransitionCallbacks
    ...
    extends IInterface
{
    ...
    public abstract boolean registerListener(ComponentName componentname, IDaydreamListener idaydreamlistener)
        throws RemoteException;

    public abstract boolean unregisterListener(ComponentName componentname)
        throws RemoteException;

    public abstract int prepareVr(ComponentName componentname, HeadTrackingState headtrackingstate)
        throws RemoteException;

    public abstract boolean deprecatedLaunchInVr(PendingIntent pendingintent)
        throws RemoteException;

    public abstract void registerDaydreamIntent(PendingIntent pendingintent)
        throws RemoteException;

    public abstract void unregisterDaydreamIntent()
        throws RemoteException;

    public abstract boolean launchInVr(PendingIntent pendingintent, ComponentName componentname)
        throws RemoteException;

    public abstract boolean launchVrHome()
        throws RemoteException;

    public abstract boolean launchVrTransition(ITransitionCallbacks itransitioncallbacks)
        throws RemoteException;

    public abstract boolean exitFromVr(PendingIntent pendingintent)
        throws RemoteException;

    public abstract void handleInsertionIntoHeadset(byte abyte0[])
        throws RemoteException;

    public abstract void handleRemovalFromHeadset()
        throws RemoteException;
}
