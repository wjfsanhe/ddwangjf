    ...
    implements IControllerListener
{
        ...
        throws RemoteException
    {
        ...
        case 3: // '\003'
            ...
            if(0 != parcel.readInt())
                controllertouchevent = (ControllerTouchEvent)ControllerTouchEvent.CREATOR.FromParcel(parcel);
            else
        ...
        case 4: // '\004'
            ...
            if(0 != parcel.readInt())
                controllerorientationevent = (ControllerOrientationEvent)ControllerOrientationEvent.CREATOR.FromParcel(parcel);
            else
        ...
        case 5: // '\005'
            ...
            if(0 != parcel.readInt())
                controllerbuttonevent = (ControllerButtonEvent)ControllerButtonEvent.CREATOR.FromParcel(parcel);
            else
        ...
        case 6: // '\006'
            ...
            if(0 != parcel.readInt())
                controllerbuttonevent1 = (ControllerButtonEvent)ControllerButtonEvent.CREATOR.FromParcel(parcel);
            else
        ...
        case 7: // '\007'
            ...
            if(0 != parcel.readInt())
                controlleraccelevent = (ControllerAccelEvent)ControllerAccelEvent.CREATOR.FromParcel(parcel);
            else
        ...
        case 8: // '\b'
            ...
            if(0 != parcel.readInt())
                controllergyroevent = (ControllerGyroEvent)ControllerGyroEvent.CREATOR.FromParcel(parcel);
            else
        ...
        case 10: // '\n'
            ...
            if(0 != parcel.readInt())
                controllereventpacket = (ControllerEventPacket)ControllerEventPacket.CREATOR.FromParcel(parcel);
            else
        ...
        case 11: // '\013'
            ...
            if(0 != parcel.readInt())
                controllerorientationevent1 = (ControllerOrientationEvent)ControllerOrientationEvent.CREATOR.FromParcel(parcel);
            else
        ...
        case 12: // '\f'
            ...
            if(0 != parcel.readInt())
                controllereventpacket2 = (ControllerEventPacket2)ControllerEventPacket2.CREATOR.FromParcel(parcel);
            else
