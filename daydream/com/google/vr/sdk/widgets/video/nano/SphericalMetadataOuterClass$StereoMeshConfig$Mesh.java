...
public static final class clear extends MessageNano
{
    ...
    public geometryType mergeFrom(CodedInputByteBufferNano input)
        throws IOException
    {
_L6:
        int tag = input.readTag();
...
_L9:
    ...
    public static geometryType parseFrom(byte data[])
        throws InvalidProtocolBufferNanoException
    {
        return (geometryType)MessageNano.mergeFrom(new <init>(), data);
    }
