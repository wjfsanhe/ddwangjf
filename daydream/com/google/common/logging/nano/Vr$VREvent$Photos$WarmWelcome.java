    ...
    implements Cloneable
{
        ...
        throws IOException
    {
        if(exitProgress != null)
            codedoutputbytebuffernano.writeFloat(1, exitProgress.floatValue());
    ...
    protected final int computeSerializedSize()
    {
        ...
        if(exitProgress != null)
            i += CodedOutputByteBufferNano.computeFloatSize(1, exitProgress.floatValue());
        return i;
    }
        ...
        throws IOException
    {
        ...
        do
            ...
            case 13: // '\r'
                clone1.exitProgress = Float.valueOf(codedinputbytebuffernano1.readFloat());
                break;
            }
        while(true);
    }
