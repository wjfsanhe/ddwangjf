    ...
    implements Cloneable
{
        ...
        throws IOException
    {
        if(originScreen != null)
            codedoutputbytebuffernano.writeInt32(1, originScreen.intValue());
        if(numPhotos != null)
            codedoutputbytebuffernano.writeInt32(2, numPhotos.intValue());
    ...
    protected final int computeSerializedSize()
    {
        ...
        if(originScreen != null)
            i += CodedOutputByteBufferNano.computeInt32Size(1, originScreen.intValue());
        if(numPhotos != null)
            i += CodedOutputByteBufferNano.computeInt32Size(2, numPhotos.intValue());
        return i;
    }
        ...
        throws IOException
    {
        ...
        do
            ...
            case 8: // '\b'
                ...
                case 1: // '\001'
                case 2: // '\002'
                    clone1.originScreen = Integer.valueOf(j);
                    break;
                }
                break;
