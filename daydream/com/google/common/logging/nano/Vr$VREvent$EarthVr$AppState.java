    ...
    implements Cloneable
{
    ...
    {
        if(appModeId != null)
            codedoutputbytebuffernano.writeInt64(1, appModeId.longValue());
    ...
    protected final int computeSerializedSize()
    {
        ...
        if(appModeId != null)
            i += CodedOutputByteBufferNano.computeInt64Size(1, appModeId.longValue());
        return i;
    }
        ...
        throws IOException
    {
        ...
        do
            ...
            case 8: // '\b'
                clone1.appModeId = Long.valueOf(codedinputbytebuffernano1.readInt64());
                break;
            }
        while(true);
    }
